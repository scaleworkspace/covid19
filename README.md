...
## Daily Updates
### 3-18-2020
Uploaded files for [Face Shield Frame v2](https://github.com/scaleworkspace/covid19/tree/master/FaceShieldV2.1?raw=true), which includes .stl, .step, .dxf, and renderings. There is also a ReadMe instructions for the files.
